...
// CompletdAt applies equality check predicate on the "completd_at" field. It's identical to CompletdAtEQ.
func CompletdAt(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldCompletdAt, v))
}
...
// CompletdAtEQ applies the EQ predicate on the "completd_at" field.
func CompletdAtEQ(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldEQ(FieldCompletdAt, v))
}

// CompletdAtNEQ applies the NEQ predicate on the "completd_at" field.
func CompletdAtNEQ(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldNEQ(FieldCompletdAt, v))
}

// CompletdAtIn applies the In predicate on the "completd_at" field.
func CompletdAtIn(vs ...time.Time) predicate.Task {
	return predicate.Task(sql.FieldIn(FieldCompletdAt, vs...))
}

// CompletdAtNotIn applies the NotIn predicate on the "completd_at" field.
func CompletdAtNotIn(vs ...time.Time) predicate.Task {
	return predicate.Task(sql.FieldNotIn(FieldCompletdAt, vs...))
}

// CompletdAtGT applies the GT predicate on the "completd_at" field.
func CompletdAtGT(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldGT(FieldCompletdAt, v))
}

// CompletdAtGTE applies the GTE predicate on the "completd_at" field.
func CompletdAtGTE(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldGTE(FieldCompletdAt, v))
}

// CompletdAtLT applies the LT predicate on the "completd_at" field.
func CompletdAtLT(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldLT(FieldCompletdAt, v))
}

// CompletdAtLTE applies the LTE predicate on the "completd_at" field.
func CompletdAtLTE(v time.Time) predicate.Task {
	return predicate.Task(sql.FieldLTE(FieldCompletdAt, v))
}

// CompletdAtIsNil applies the IsNil predicate on the "completd_at" field.
func CompletdAtIsNil() predicate.Task {
	return predicate.Task(sql.FieldIsNull(FieldCompletdAt))
}

// CompletdAtNotNil applies the NotNil predicate on the "completd_at" field.
func CompletdAtNotNil() predicate.Task {
	return predicate.Task(sql.FieldNotNull(FieldCompletdAt))
}
